...
public class Player : MonoBehaviour
{
    ...
    //further I would seperate player health, movement, ui, and shooting into seperate scripts 
    ...
    public void OnShoot()
    {
        ...
        if (Time.time >= lastShootTime + shootCooldown)
        {
            ...
            { 
                ...
                //Make bullet shoot from screen center for cinemachine camera
                GameObject bullet = GameObject.Instantiate(bulletObj, shootDirection, Quaternion.identity);
